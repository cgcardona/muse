...
3. [Argument I: Byte-Level Equality Loses Semantic Identity](#3-argument-i)
4. [Argument II: No Flat Projection Preserves Dimensional Independence](#4-argument-ii)
5. [Argument III: Merge Requires Causal Awareness](#5-argument-iii)
6. [Argument IV: Entity Identity Cannot Be Recovered from Bytes](#6-argument-iv)
7. [Argument V: Semantic Versioning Is a Structural Property](#7-argument-v)
8. [The Muse Architecture: A Constructive Counter-Proof](#8-the-muse-architecture)
9. [The MuseDomainPlugin Protocol: Six Methods That Cannot Be Bytes](#9-the-musedomain-plugin-protocol)
10. [The Typed Operation Algebra: The Language Bytes Don't Speak](#10-the-typed-operation-algebra)
11. [The Merge Hierarchy: From File to Dimension to Operation](#11-the-merge-hierarchy)
12. [CRDT Convergence: When Three-Way Merge Is the Wrong Model](#12-crdt-convergence)
13. [Cross-Domain Generalization: Evidence Beyond Music](#13-cross-domain-generalization)
14. [Related Work](#14-related-work)
15. [Discussion and Implications](#15-discussion-and-implications)
16. [Conclusion](#16-conclusion)
17. [Appendix A: The 21 Dimensions of MIDI State](#appendix-a)
18. [Appendix B: The Operation Commutativity Table](#appendix-b)
19. [Appendix C: Formal Definitions](#appendix-c)
