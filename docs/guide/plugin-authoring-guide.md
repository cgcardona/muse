...
3. [Core Protocol (Required)](#core-protocol-required)
4. [Domain Schema](#domain-schema)
5. [Operation-Level Merge (OT)](#operation-level-merge-ot)
6. [CRDT Semantics](#crdt-semantics)
