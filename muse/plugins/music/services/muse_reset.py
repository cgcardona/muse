...
- **hard** — moves the branch ref AND overwrites ``muse-work/`` with the
  ...
  restored via :mod:`muse.core.object_store` (the canonical blob
...
via :mod:`muse.core.object_store`. If an object is missing, hard
...
from muse.cli.models import MuseCliCommit
from muse.core.object_store import has_object, object_path, restore_object
