...
from muse.plugins.music.services.muse_checkout import CheckoutPlan, build_checkout_plan
from muse.plugins.music.services.muse_merge_base import find_merge_base
from muse.plugins.music.services.muse_replay import HeadSnapshot, reconstruct_variation_snapshot
from muse.plugins.music.services.variation.note_matching import (
    EventMatch,
    NoteMatch,
    match_aftertouch,
    match_cc_events,
    ...
    *,
    ...
    if result.has_conflicts:
        ...
        if repo_path is not None:
            try:
                from muse.plugins.music.services.muse_rerere import (
                    ConflictDict,
                    apply_rerere,
                    record_conflict,
                )
...
def _check_addition_overlaps(
    ...
    from muse.plugins.music.services.variation.note_matching import _notes_match
